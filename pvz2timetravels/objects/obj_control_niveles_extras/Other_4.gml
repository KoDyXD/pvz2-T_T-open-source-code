...
if instance_exists(nivel_debug_xd)
{
	...
	{
		instance_destroy(nivel_debug_xd);
		instance_create_layer(0,0,"hud",nivel_editor_0_0);
	}
}
...
if instance_exists(nivel_debug_xd) or instance_exists(objetivo_cuales) or instance_exists(mund_espiral2) or instance_exists(nivel_editor_0_0) or instance_exists(oNivelTutorialSaltar)
{
	alarm_set(8,1);
}

...
scr_mod_nivel(id,musica_egipto,spr_patio_egipto,2,16,2,"Desafío solar 2");	//configuracion base del nivel
...
instance_create_zombis_muestras(zombi_egipto_explorador,5,5);

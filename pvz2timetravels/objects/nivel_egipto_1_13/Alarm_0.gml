...
if oleada = 7
{
	...
	instance_create_zombis(-1,-2,2,2,zombi_egipto_explorador);
}
...
if oleada = 16
{
	...
	instance_create_zombis(-1,1,2,2,zombi_egipto_explorador);
	instance_create_zombis(-1,2,2,2,zombi_egipto_explorador);
	instance_create_zombis(-1,3,2,2,zombi_egipto_explorador);
	instance_create_zombis(-1,4,2,2,zombi_egipto_explorador);
	instance_create_zombis(-1,5,2,2,zombi_egipto_explorador);
	instance_create_zombis(1,1,1,1,zombi_egipto_explorador);
	instance_create_zombis(1,2,1,1,zombi_egipto_explorador);
	instance_create_zombis(1,3,1,1,zombi_egipto_explorador);
	instance_create_zombis(1,4,1,1,zombi_egipto_explorador);

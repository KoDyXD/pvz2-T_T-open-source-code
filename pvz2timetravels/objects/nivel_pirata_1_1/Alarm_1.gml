...
if global.cuentasem < 6
{
	...
	if global.semilla_girasol = true {var _inst = instance_create_layer(_x,_y+151*0,"hud",semillero_girasol);}
	if global.semilla_lanzaguiasntes = true {var _inst = instance_create_layer(_x,_y+151*1,"hud",semillero_lanzaguisantes);}

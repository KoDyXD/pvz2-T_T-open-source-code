...
tipo = 16;		//que sprite creara
preview = prev_repetidora;	//que preview creara en el menu recompensa
cual = 11;			//mostrar descripcion de la recompensa en su menu
...
if global.semilla_repetidora = false {global.cuentasem += 1;}
global.semilla_repetidora = true;
ini_open(global.nombre);
ini_write_real("Semilla", "cuantas", global.cuentasem);
ini_write_real("Semilla", "repetidora", global.semilla_repetidora);
ini_close();
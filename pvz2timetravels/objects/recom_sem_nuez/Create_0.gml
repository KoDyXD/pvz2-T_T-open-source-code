...
tipo = 2;		//que sprite creara
preview = prev_nuez;	//que preview creara en el menu recompensa
cual = 2;			//mostrar descripcion de la recompensa en su menu
...
if global.semilla_nuez = false {global.cuentasem += 1;}

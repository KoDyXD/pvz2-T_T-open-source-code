...
scr_mod_nivel(id,musica_patiofrontal_UB,spr_patio_tutorial,-1,16,1,"Tutorial 5");	//configuracion base del nivel
scr_mod_nivel_extras(3,-1);
...
//zombis de muestra
instance_create_zombis_muestras(zombi_tut_basico,4,7);
instance_create_zombis_muestras(zombi_tut_caracono,2,5);
instance_create_zombis_muestras(zombi_tut_caracubo,3,5);

...
tipo = 1;		//que sprite creara
preview = prev_papapum;	//que preview creara en el menu recompensa
cual = 3;			//mostrar descripcion de la recompensa en su menu
...
if global.semilla_papapum = false {global.cuentasem += 1;}

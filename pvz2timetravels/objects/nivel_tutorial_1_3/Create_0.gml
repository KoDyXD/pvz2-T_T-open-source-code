...
instance_create_planta(6,2,planta_lanzaguisantes,true);
instance_create_planta(8,3,planta_lanzaguisantes,true);
instance_create_planta(7,4,planta_lanzaguisantes,true);
...
scr_mod_nivel(id,musica_patiofrontal,spr_patio_tutorial,-1,8,1,"Tutorial 3");	//configuracion base del nivel
...
//zombis de muestra
instance_create_zombis_muestras(zombi_tut_basico,3,4);
instance_create_zombis_muestras(zombi_tut_caracono,1,2);
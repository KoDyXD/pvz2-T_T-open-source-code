...
tipo = 18;		//que sprite creara
preview = prev_bolos_nuez;	//que preview creara en el menu recompensa
...
if global.semilla_bolos_nueces = false {global.cuentasem += 1;}
global.semilla_bolos_nueces = true;
ini_open(global.nombre);
ini_write_real("Semilla", "cuantas", global.cuentasem);
ini_write_real("Semilla", "nueces", global.semilla_bolos_nueces);
ini_close();
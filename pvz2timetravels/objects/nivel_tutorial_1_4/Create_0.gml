...
scr_mod_nivel(id,musica_patiofrontal,spr_patio_tutorial,-1,8,1,"Tutorial 4");	//configuracion base del nivel
...
//zombis de muestra
instance_create_zombis_muestras(zombi_tut_basico,3,6);
instance_create_zombis_muestras(zombi_tut_caracono,2,3);
instance_create_zombis_muestras(zombi_tut_caracubo,1,2);
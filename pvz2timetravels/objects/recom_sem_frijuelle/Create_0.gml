...
tipo = 24;		//que sprite creara
preview = prev_frijuelle;	//que preview creara en el menu recompensa
cual = 18;			//mostrar descripcion de la recompensa en su menu
...
if global.semilla_frijuelle = false {global.cuentasem += 1;}
global.semilla_frijuelle = true;
ini_open(global.nombre);
ini_write_real("Semilla", "cuantas", global.cuentasem);
ini_write_real("Semilla", "frijuelle", global.semilla_frijuelle);
ini_close();
...
if intro = true
{
	if audio_is_playing(music_pirata_special_2) and audio_sound_get_track_position(duracion) > 181.1
	{
		duracion = audio_play_sound(music_pirata_special_2,1000,0);
	}
	if !audio_is_playing(duracion) {duracion = audio_play_sound(music_pirata_special_2,1000,0);}
}
#endregion
#region//oleada2

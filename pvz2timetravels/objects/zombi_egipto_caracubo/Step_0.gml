...
{
	if escudo > 400 and escudo <= 800 and skeleton_skin_get() != "cubo/2/entero"{skeleton_skin_set("cubo/2/entero");}
	if escudo <= 400 and skeleton_skin_get() != "cubo/3/entero"{skeleton_skin_set("cubo/3/entero");}
}
...
if hp <= 0
{
	if anim_nada = false {var _mo = instance_create_depth(x,y,0,zombi_egipto_morir); _mo.depth = depth;}
	if anim_expl = false
	{

...
if oleada = 5
{
	...
	instance_create_zombis(0,-5,1,1,zombi_egipto_caracono);
}

if oleada = 6
{
	instance_create_zombis(-1,0,1,1,zombi_egipto_zombidito);
	instance_create_zombis(0,-3,1,1,zombi_egipto_caracubo);
}

if oleada = 7
{
	instance_create_zombis(1,0,3,4,zombi_egipto_zombidito);
	instance_create_zombis(-1,0,2,2,zombi_egipto_basico);
...
if oleada = 8
{
	instance_create_zombis(-1,-2,2,2,zombi_egipto_ra);
...
{
	instance_create_zombis(0,-3,1,1,zombi_egipto_caracono);
	instance_create_zombis(0,-2,1,1,zombi_egipto_caracubo);
	instance_create_zombis(-1,0,3,3,zombi_egipto_zombidito);
}

if oleada = 11
{
	instance_create_zombis(-1,-2,5,5,zombi_egipto_ra);
	instance_create_zombis(-1,-3,1,1,zombi_egipto_basico);
}
...
if oleada = 13
{
	instance_create_zombis(-1,0,6,6,zombi_egipto_zombidito);
	instance_create_zombis(0,1,1,1,zombi_egipto_camello);
	instance_create_zombis(0,3,1,1,zombi_egipto_camello);
	instance_create_zombis(0,5,1,1,zombi_egipto_camello);	
}

if oleada = 14
{
	instance_create_zombis(-1,0,4,4,zombi_egipto_ra);
	instance_create_zombis(0,-3,1,1,zombi_egipto_explorador);
}
...
if oleada = 15
{
	...
	instance_create_zombis(0,0,7,7,zombi_egipto_zombidito);
	...
	instance_create_zombis(0,4,1,1,zombi_egipto_camello);
}
...
obj = semillero_bolos_nueces;	//que semilla creara al iniciar el nivel
desbloquear = global.semilla_bolos_nueces;	//saber si la planta ya esta desbloqueada
selector = selector_bolos_nueces;	//que selector creara
tipo = 18;		//que sprite dibujara

sprite = prev_bolos_nuez;	//sprite a mostrar
name = "Nueces de bolera";	//nombre a mostrar

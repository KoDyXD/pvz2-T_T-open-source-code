...
if oleada = 5
{
	instance_create_zombis(-1,0,1,1,zombi_egipto_faraon);
}
...
if oleada = 7
{
	instance_create_zombis(0,-2,3,3,zombi_egipto_anubis);
	instance_create_zombis(-1,2,1,1,zombi_egipto_camello);
}

if oleada = 8
{
	instance_create_zombis(1,-10,2,2,zombi_egipto_caracubo);
	instance_create_zombis(1,-9,2,2,zombi_egipto_caracubo);
	instance_create_zombis(-1,0,4,4,zombi_egipto_basico);
}

if oleada = 9
{
	instance_create_zombis(-1,4,0,1,zombi_egipto_camello);

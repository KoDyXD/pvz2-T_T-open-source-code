...
if oleada = 3
{
	instance_create_zombis(-1,2,1,1,zombi_egipto_basico);
}

if oleada = 4
{
	instance_create_zombis(-1,1,1,1,zombi_egipto_ra);
...
if oleada = 6
{
	instance_create_zombis(1,-2,2,2,zombi_egipto_basico);
...
if oleada = 9
{
	...
	instance_create_zombis(-1,0,3,3,zombi_egipto_ra);
}
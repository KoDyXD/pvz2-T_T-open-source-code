...
tipo = 10;		//que sprite creara
preview = prev_boomerang;	//que preview creara en el menu recompensa
cual = 7;			//mostrar descripcion de la recompensa en su menu
...
if global.semilla_boomerang = false {global.cuentasem += 1;}
global.semilla_boomerang = true;
ini_open(global.nombre);
ini_write_real("Semilla", "cuantas", global.cuentasem);
ini_write_real("Semilla", "boomerang", global.semilla_boomerang);
ini_close();
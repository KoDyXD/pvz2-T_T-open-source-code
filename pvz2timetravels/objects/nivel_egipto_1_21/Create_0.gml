...
scr_mod_nivel(id,musica_egipto_special_2,spr_patio_egipto,0,15,1,"Desafío Protector 1");	//configuracion base del nivel
...
scr_nivel_desafios(
	[
		[objetivo_planta_proteger,5,1,planta_girasol],
		[objetivo_planta_proteger,4,2,planta_girasol],
		[objetivo_planta_proteger,4,4,planta_girasol],
		[objetivo_planta_proteger,5,5,planta_girasol],
		[objetivo_no_solares],
	]
)
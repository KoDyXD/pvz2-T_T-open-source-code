...
tipo = 25;		//que sprite creara
preview = prev_pinchohierba;	//que preview creara en el menu recompensa
cual = 19;			//mostrar descripcion de la recompensa en su menu
...
if global.semilla_pinchohierba = false {global.cuentasem += 1;}
global.semilla_pinchohierba = true;
ini_open(global.nombre);
ini_write_real("Semilla", "cuantas", global.cuentasem);
ini_write_real("Semilla", "pinchohierba", global.semilla_pinchohierba);
ini_close();
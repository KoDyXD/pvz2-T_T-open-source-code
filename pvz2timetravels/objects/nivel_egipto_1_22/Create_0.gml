...
scr_mod_nivel(id,musica_egipto,spr_patio_egipto,2,15,1,"Desafío Protector 2");	//configuracion base del nivel
...
instance_create_zombis_muestras(zombi_egipto_zombidito,4,4);

scr_nivel_desafios(
	[
		[objetivo_planta_proteger,6,2,planta_bonkchoy],
		[objetivo_planta_proteger,6,4,planta_bonkchoy],
		[objetivo_plantas_limite,17],

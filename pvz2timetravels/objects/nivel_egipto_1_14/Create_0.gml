...
scr_mod_nivel(id,musica_egipto,spr_patio_egipto,0,15,1,"Desafío solar 4");	//configuracion base del nivel
...
instance_create_zombis_muestras(zombi_egipto_anubis,5,5);

scr_nivel_desafios(
	[
		[objetivo_soles_limite,2200],
	]
)
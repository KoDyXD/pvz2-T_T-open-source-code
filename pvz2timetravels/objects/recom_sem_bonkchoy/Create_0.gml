...
tipo = 20;		//que sprite creara
preview = prev_bonkchoy;	//que preview creara en el menu recompensa
cual = 15;			//mostrar descripcion de la recompensa en su menu
...
if global.semilla_bonkchoy = false {global.cuentasem += 1;}
global.semilla_bonkchoy = true;
ini_open(global.nombre);
ini_write_real("Semilla", "cuantas", global.cuentasem);
ini_write_real("Semilla", "bonkchoy", global.semilla_bonkchoy);
ini_close();
...
tipo = 13;		//que sprite creara
preview = prev_bolos_explotonuez;	//que preview creara en el menu recompensa
cual = 12;			//mostrar descripcion de la recompensa en su menu
...
if global.semilla_bolos_explotonuez = false {global.cuentasem += 1;}
global.semilla_bolos_explotonuez = true;
ini_open(global.nombre);
ini_write_real("Semilla", "cuantas", global.cuentasem);
ini_write_real("Semilla", "explotonuez", global.semilla_bolos_explotonuez);
ini_close();
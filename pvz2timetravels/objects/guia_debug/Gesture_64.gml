...
with(obj_click)
{
	if x > 6*166 and y > 3*186 and x < 15*166 and y < 8*186 and !place_meeting(x,y,semillero_debug) and !place_meeting(x,y,pala_base) and !place_meeting(x,y,menu_boton_pausar)
	{
		var mouse_grid_x = mouse_x div 166;
		var mouse_grid_y = mouse_y div 186;

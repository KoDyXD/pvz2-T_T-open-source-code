...
tipo = 15;		//que sprite creara
preview = prev_carnivora;	//que preview creara en el menu recompensa
...
if global.semilla_carnivora = false {global.cuentasem += 1;}
global.semilla_carnivora = true;
ini_open(global.nombre);
ini_write_real("Semilla", "cuantas", global.cuentasem);
ini_write_real("Semilla", "carnivora", global.semilla_carnivora);
ini_close();
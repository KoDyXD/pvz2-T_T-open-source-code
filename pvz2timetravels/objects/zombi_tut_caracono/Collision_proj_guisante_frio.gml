...
if (i != noone)
{
	if escudo > 0 {escudo -= i.dano;}else{hp -= i.dano;}
		...
		image_blend = $FFB93C;
		alarm_set(7,10*60);
		if escudo > 0 {audio_play_sound(choose(sound_impacto_cono_1,sound_impacto_cono_2),1,0);}else{audio_play_sound(choose(sound_hielaguisantes_impacto_1,sound_hielaguisantes_impacto_2,sound_hielaguisantes_impacto_3),1,0);}

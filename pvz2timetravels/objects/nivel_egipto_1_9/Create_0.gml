...
instance_create_tumba(5,3,tumba_egipto);
...
scr_mod_nivel(id,musica_egipto,spr_patio_egipto,0,20,1,"Antiguo Egipto 1-9");	//configuracion base del nivel
...
instance_create_zombis_muestras(zombi_egipto_anubis,1,2);
...
scr_mod_nivel(id,musica_egipto,spr_patio_egipto,2,15,1,"Desafío Protector 4");	//configuracion base del nivel
...
instance_create_zombis_muestras(zombi_egipto_ra,2,2);
instance_create_zombis_muestras(zombi_egipto_camello,1,1);

scr_nivel_desafios(
	[
		[objetivo_planta_proteger,6,1,planta_nuez],
		[objetivo_planta_proteger,6,2,planta_nuez],
		[objetivo_planta_proteger,6,3,planta_nuez],
		[objetivo_planta_proteger,6,4,planta_nuez],
		[objetivo_planta_proteger,6,5,planta_nuez],

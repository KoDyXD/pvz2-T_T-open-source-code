...
{
	instance_create_zombis(-1,0,1,1,zombi_egipto_basico);
	instance_create_zombis(-1,0,1,1,zombi_egipto_caracubo);
}
...
if oleada = 9
{
	...
	instance_create_zombis(-1,-3,2,2,zombi_egipto_caracono);
}
...
if oleada = 15
{
	...
	instance_create_zombis(-1,3,1,1,zombi_egipto_camello);
	instance_create_zombis(-1,5,1,1,zombi_egipto_camello);
	instance_create_zombis(2,0,2,2,zombi_egipto_caracono);
	instance_create_zombis(2,2,1,1,zombi_egipto_caracubo);
	instance_create_zombis(2,4,1,1,zombi_egipto_caracubo);
}
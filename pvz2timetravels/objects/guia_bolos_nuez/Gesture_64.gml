...
with(obj_click)
{
	if x > 6*166 and y > 3*186 and x < 15*166 and !place_meeting(x,y,semillero_debug) and !place_meeting(x,y,pala_base) and !place_meeting(x,y,menu_boton_pausar)
	{
		...
		if !collision_rectangle(mouse_grid_x*166,mouse_grid_y*186,mouse_grid_x*166+166,mouse_grid_y*186+186,oPlantaGeneral,0,1) and !collision_rectangle(mouse_grid_x*166,mouse_grid_y*186,mouse_grid_x*166+166,mouse_grid_y*186+186,tumba_egipto,0,1) and mouse_x <= other.limite and !collision_rectangle(mouse_grid_x*166,mouse_grid_y*186,mouse_grid_x*166+166,mouse_grid_y*186+186,casillas_ocupada,0,1) and !collision_rectangle(mouse_grid_x*166,mouse_grid_y*186,mouse_grid_x*166+166,mouse_grid_y*186+186,casillas_no_plantable,0,1)
		{
			with(other)
			{

...
if oleada = 7
{
	instance_create_zombis(0,-3,0,1,zombi_egipto_caracono);
...
if oleada = 8
{
	instance_create_zombis(1,5,1,1,choose(zombi_egipto_caracubo,zombi_egipto_caracono));
}
...
if oleada = 12
{
	...
	instance_create_zombis(-1,3,0,1,zombi_egipto_caracono);
}
...
if oleada = 15
{
	...
	instance_create_zombis(3,2,1,1,zombi_egipto_caracubo);
	instance_create_zombis(3,4,1,1,zombi_egipto_caracubo);
	instance_create_zombis(3,1,1,1,zombi_egipto_camello);

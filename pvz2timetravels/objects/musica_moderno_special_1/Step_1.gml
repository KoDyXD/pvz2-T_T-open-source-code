...
if intro = true
{
	if audio_is_playing(music_moderno_special_1) and audio_sound_get_track_position(duracion) > 181.27
	{
		duracion = audio_play_sound(music_moderno_special_1,1000,0);
	}
	if !audio_is_playing(duracion) {duracion = audio_play_sound(music_futuro_special_1,1000,0);}
}
#endregion
#region//oleada2

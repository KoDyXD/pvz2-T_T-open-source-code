...
if oleada = 2
{
	instance_create_zombis(0,0,4,4,zombi_egipto_caracono);
}

if oleada <= 3
{
	instance_create_zombis(0,0,6,6,zombi_egipto_basico);
}
...
if oleada = 5
{
	instance_create_tumbas(4,1,9,5,5,10,tumba_egipto);
	instance_create_zombis(-1,-5,4,4,zombi_egipto_basico);
	instance_create_zombis(0,-1,3,3,zombi_egipto_caracono);
}
...
if oleada = 9
{
	instance_create_zombis(-1,0,3,3,zombi_egipto_caracubo);
}

if oleada = 10
{
	instance_create_tumbas(2,2,9,2,9,10,tumba_egipto);
	instance_create_tumbas(2,4,9,4,9,10,tumba_egipto);
	instance_create_zombis(0,-3,1,1,zombi_egipto_explorador);
	instance_create_zombis(0,-2,1,1,zombi_egipto_explorador);
...
if oleada = 11
{
	...
	instance_create_zombis(-1,-2,0,2,zombi_egipto_caracono)
}
...
{
	alarm_set(3,1);
	instance_create_tumbas(1,1,9,5,9,13,tumba_egipto);

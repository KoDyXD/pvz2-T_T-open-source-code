...
tipo = 29;		//que sprite creara
preview = prev_pinchorroca;	//que preview creara en el menu recompensa
cual = 10;			//mostrar descripcion de la recompensa en su menu
...
if global.semilla_pinchorroca = false {global.cuentasem += 1;}
global.semilla_pinchorroca = true;
ini_open(global.nombre);
ini_write_real("Semilla", "cuantas", global.cuentasem);
ini_write_real("Semilla", "pinchorroca", global.semilla_pinchorroca);
ini_close();
...
scr_mod_nivel(id,musica_egipto,spr_patio_egipto,0,16,2,"Desafío Protector 2");	//configuracion base del nivel
...
scr_nivel_desafios(
	[
		[objetivo_planta_proteger,7,1,planta_carnivora],
		[objetivo_planta_proteger,7,5,planta_carnivora],
		[objetivo_planta_proteger,6,3,planta_papapum],
	]
)
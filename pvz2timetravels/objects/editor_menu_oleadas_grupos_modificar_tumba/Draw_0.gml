if instance_exists(padre)
{
	...
	draw_text_outline_transformed(camera_get_view_x(view_camera[0])+camera_get_view_width(view_camera[0])/2,camera_get_view_y(view_camera[0])+175,"GENERADOR DE TUMBA",1,1,c_white,c_black,1.75,1.75,0);
	...
	draw_text_outline_trans_ext(_x-260,_y+150,"Tumba:",1,1,$68DCFD,c_black,45,450,1.5,1.5,0);

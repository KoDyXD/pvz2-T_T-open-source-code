...
if !instance_exists(prev) and semilla = true and click2 == true
{
	...
	scr_almanaque_stats(4,almanaque_stat_planta_ataque,1800);
	scr_almanaque_stats(5,almanaque_stat_planta_area,"1x1");
	scr_almanaque_stats(6,almanaque_stat_planta_armar,14);
}
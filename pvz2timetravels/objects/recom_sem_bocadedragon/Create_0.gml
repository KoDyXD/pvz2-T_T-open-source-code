...
tipo = 27;		//que sprite creara
preview = prev_bocadedragon;	//que preview creara en el menu recompensa
cual = 21;			//mostrar descripcion de la recompensa en su menu
...
if global.semilla_bocadedragon = false {global.cuentasem += 1;}
global.semilla_bocadedragon = true;
ini_open(global.nombre);
ini_write_real("Semilla", "cuantas", global.cuentasem);
ini_write_real("Semilla", "bocadedragon", global.semilla_bocadedragon);
ini_close();
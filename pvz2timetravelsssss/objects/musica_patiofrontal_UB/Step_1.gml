...
if intro = true
{
	if audio_is_playing(music_patio_frontal_UB) and audio_sound_get_track_position(duracion) > 104
	{
		duracion = audio_play_sound(music_patio_frontal_UB,1000,0);
	}
	if !audio_is_playing(duracion) {duracion = audio_play_sound(music_patio_frontal_UB,1000,0);}
}
#endregion
#region//oleada2

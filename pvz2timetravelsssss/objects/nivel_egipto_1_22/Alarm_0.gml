...
if oleada = 5
{
	...
	instance_create_zombis(0,0,1,1,zombi_egipto_anubis);
}
...
if oleada = 7
{
	...
	instance_create_zombis(0,-4,1,1,zombi_egipto_caracono);
}

if oleada = 8
{
	instance_create_zombis(-1,0,2,2,zombi_egipto_anubis);
...
if oleada = 11
{
	...
	instance_create_zombis(0,0,5,5,zombi_egipto_zombidito);
}

if oleada = 12
{
	instance_create_zombis(-1,2,1,1,zombi_egipto_anubis);
	instance_create_zombis(-1,4,1,1,zombi_egipto_anubis);
	instance_create_zombis(1,1,0,1,zombi_egipto_anubis);
	instance_create_zombis(1,3,1,1,zombi_egipto_anubis);
...
if oleada = 14
{
	instance_create_zombis(0,0,3,3,zombi_egipto_anubis);
}

if oleada = 15
{
	instance_create_zombis(0,0,6,6,zombi_egipto_zombidito);
	instance_create_zombis(0,0,1,1,zombi_egipto_basico);
	instance_create_zombis(-1,1,1,1,zombi_egipto_explorador);
	instance_create_zombis(-1,3,1,1,zombi_egipto_explorador);
	instance_create_zombis(-1,5,1,1,zombi_egipto_explorador);

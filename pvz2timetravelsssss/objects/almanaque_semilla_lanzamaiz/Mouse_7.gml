...
if !instance_exists(prev) and semilla = true and click2 == true
{
	...
	global.name = "Lanzamaiz";
	global.desc = texto;
	global.fondo = 2;
	
	global.stat1.valor = 100;
	global.stat2.valor = 5;
	global.stat3.valor = 300;
	scr_almanaque_stats(4,almanaque_stat_planta_ataque,20);
	scr_almanaque_stats(5,almanaque_stat_planta_rango,"Largo");
	scr_almanaque_stats(6,almanaque_stat_planta_especial,"Mantequilla");
}
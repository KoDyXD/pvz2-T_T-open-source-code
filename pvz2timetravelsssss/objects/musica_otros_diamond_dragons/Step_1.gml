...
if intro = true
{
	if audio_is_playing(music_otros_diamond_dragons) and audio_sound_get_track_position(duracion) > 242
	{
		duracion = audio_play_sound(music_otros_diamond_dragons,1000,0);
	}
	if !audio_is_playing(duracion) {duracion = audio_play_sound(music_otros_diamond_dragons,1000,0);}
}
#endregion
#region//oleada2

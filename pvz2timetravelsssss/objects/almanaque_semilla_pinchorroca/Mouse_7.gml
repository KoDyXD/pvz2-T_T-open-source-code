...
if !instance_exists(prev) and semilla = true and click2 == true
{
	...
	global.name = "Pinchorroca";
	global.desc = texto;
	global.fondo = 2;
	
	global.stat1.valor = 250;
	global.stat2.valor = 5;
	global.stat3.valor = 3000;
	scr_almanaque_stats(4,almanaque_stat_planta_ataque,45);
	scr_almanaque_stats(5,almanaque_stat_planta_rango,"Al Contacto");
	scr_almanaque_stats(6,almanaque_stat_planta_especial,"Romper barriles");
}
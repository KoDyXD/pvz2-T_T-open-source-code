...
tipo = 14;		//que sprite creara
preview = prev_comepiedras;	//que preview creara en el menu recompensa
cual = 9;			//mostrar descripcion de la recompensa en su menu
...
if global.semilla_comepiedras = false {global.cuentasem += 1;}
global.semilla_comepiedras = true;
ini_open(global.nombre);
ini_write_real("Semilla", "cuantas", global.cuentasem);
ini_write_real("Semilla", "comepiedras", global.semilla_comepiedras);
ini_close();
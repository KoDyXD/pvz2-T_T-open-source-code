...
scr_mod_nivel(id,musica_egipto_special_1,spr_patio_egipto,2,15,1,"Bolera 4");	//configuracion base del nivel
...
instance_create_zombis_muestras(zombi_egipto_faraon,3,3);

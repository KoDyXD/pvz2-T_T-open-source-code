...
if os_type = os_android
{
	if keyboard_virtual_status() = false
	{
		...
		draw_text_outline_transformed(room_width/2,400,"RENOMBRAR PERFIL",1,1,c_white,c_black,1.75,1.75,0);
	...
	else
	{
		...
		draw_set_valign(fa_middle);
		draw_set_halign(fa_center);
		draw_text_outline_transformed(room_width/2,70,"RENOMBRAR PERFIL",1,1,c_white,c_black,1.75,1.75,0);

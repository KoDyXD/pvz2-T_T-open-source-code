...
if oleada = 9
{
	instance_create_zombis(0,0,4,4,zombi_egipto_explorador);
...
if oleada = 12
{
	instance_create_zombis(-1,2,1,1,zombi_egipto_camello);
	instance_create_zombis(-1,4,1,1,zombi_egipto_camello);
	instance_create_zombis(0,0,3,3,zombi_egipto_ra);
}
...
if oleada = 15
{
	instance_create_zombis(1,3,1,1,zombi_egipto_zombistein);
	instance_create_zombis(0,0,2,2,zombi_egipto_ra);
	instance_create_zombis(1,0,3,3,zombi_egipto_caracono);
	instance_create_zombis(-1,1,1,1,zombi_egipto_explorador);

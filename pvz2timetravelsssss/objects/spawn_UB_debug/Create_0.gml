...
//este objeto es un objeto padre para todos los niveles con cinta transportadora
//al colocarse este objeto en una deteccion, la deteccion tambien sera posible
//con todos los objetos hijos que tenga el padre
...
if desvanecer = false {if image_xscale < tam_original {image_xscale += 0.05; image_yscale += 0.05;} if image_alpha < 1 {image_alpha += 0.04;}}
#endregion
...
if mov = true
{
	...
	z = scr_proj_arco(0,altura,0,recorrer/recorrido,0.7);

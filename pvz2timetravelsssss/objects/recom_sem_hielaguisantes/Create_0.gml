...
tipo = 11;		//que sprite creara
preview = prev_hielaguisantes;	//que preview creara en el menu recompensa
cual = 8;			//mostrar descripcion de la recompensa en su menu
...
if global.semilla_hielaguisantes = false {global.cuentasem += 1;}
global.semilla_hielaguisantes = true;
ini_open(global.nombre);
ini_write_real("Semilla", "cuantas", global.cuentasem);
ini_write_real("Semilla", "hielaguisantes", global.semilla_hielaguisantes);
ini_close();
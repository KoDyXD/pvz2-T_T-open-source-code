...
if !instance_exists(prev) and semilla = true and click2 == true
{
	...
	var i = instance_create_depth(room_width/2+579,835,0,prev);
	i.image_xscale = 1.4;
	i.image_yscale = 1.4;
	global.name = "Momia camello";
	global.fondo = 1;
	global.desc = texto;
	
	global.stat1.valor = "Cansado";
	global.stat2.valor = 580;
	global.stat3.valor = 0;
	scr_almanaque_stats(4,almanaque_stat_zombi_especial,"Cambia de velocidad");

...
if global.cuentasem < 6
{
	...
	if global.semilla_lanzaguiasntes = true {var _inst = instance_create_layer(_x,_y+151*0,"hud",semillero_lanzaguisantes);}
	if global.semilla_nuez = true {var _inst = instance_create_layer(_x,_y+151*1,"hud",semillero_nuez);}
	if global.semilla_papapum = true {var _inst = instance_create_layer(_x,_y+151*2,"hud",semillero_papapum);}
	if global.semilla_coltapulta = true {var _inst = instance_create_layer(_x,_y+151*3,"hud",semillero_coltapulta);}
	if global.semilla_boomerang = true {var _inst = instance_create_layer(_x,_y+151*4,"hud",semillero_boomerang);}
	if global.semilla_hielaguisantes = true {var _inst = instance_create_layer(_x,_y+151*5,"hud",semillero_hielaguisantes);}
}

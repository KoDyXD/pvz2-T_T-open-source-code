...
if hp <= 0
{
	if anim_nada = false {var _mo = instance_create_depth(x,y,0,zombi_tut_morir); _mo.depth = depth; with(_mo){skeleton_skin_set("aband/muerto"); skeleton_animation_set("aband/muerte");}}
	if anim_expl = false
	{

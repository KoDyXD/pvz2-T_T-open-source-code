...
if oleada <= 3
{
	instance_create_zombis(-1,3,1,1,zombi_tut_basico);
}

if oleada = 4
{
	instance_create_zombis(-1,3,2,2,zombi_tut_basico);
}

//oleada masiva
if oleada = 5
{
	instance_create_zombis(-1,3,1,2,zombi_tut_basico);
	instance_create_zombis(1,3,0,2,zombi_tut_basico);
}
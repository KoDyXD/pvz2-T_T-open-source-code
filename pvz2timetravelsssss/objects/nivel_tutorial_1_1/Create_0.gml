...
global.soles += 100;	///aumentar 100 soles
...
scr_mod_nivel(id,musica_patiofrontal,spr_patio_tutorial,-1,5,1,"Tutorial 1");	//configuracion base del nivel
...
//zombis de muestra
instance_create_zombis_muestras(zombi_tut_basico,2,4);

if global.nivel_tutorial[1] = false
{
	instance_create_layer(0,0,"hud",oNivelTutorialSaltar);
}
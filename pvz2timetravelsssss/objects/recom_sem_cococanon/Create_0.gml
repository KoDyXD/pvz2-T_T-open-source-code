...
tipo = 26;		//que sprite creara
preview = prev_cococanon;	//que preview creara en el menu recompensa
cual = 20;			//mostrar descripcion de la recompensa en su menu
...
if global.semilla_cococanon = false {global.cuentasem += 1;}
global.semilla_cococanon = true;
ini_open(global.nombre);
ini_write_real("Semilla", "cuantas", global.cuentasem);
ini_write_real("Semilla", "cococanon", global.semilla_cococanon);
ini_close();
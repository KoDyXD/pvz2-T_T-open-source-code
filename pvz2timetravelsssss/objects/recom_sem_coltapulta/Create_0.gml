...
tipo = 9;		//que sprite creara
preview = prev_coltapulta;	//que preview creara en el menu recompensa
cual = 6;			//mostrar descripcion de la recompensa en su menu
...
if global.semilla_coltapulta = false {global.cuentasem += 1;}
global.semilla_coltapulta = true;
ini_open(global.nombre);
ini_write_real("Semilla", "cuantas", global.cuentasem);
ini_write_real("Semilla", "coltapulta", global.semilla_coltapulta);
ini_close();
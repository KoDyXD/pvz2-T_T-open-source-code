...
tipo = 23;		//que sprite creara
preview = prev_lanzamaiz;	//que preview creara en el menu recompensa
cual = 17;			//mostrar descripcion de la recompensa en su menu
...
if global.semilla_lanzamaiz = false {global.cuentasem += 1;}
global.semilla_lanzamaiz = true;
ini_open(global.nombre);
ini_write_real("Semilla", "cuantas", global.cuentasem);
ini_write_real("Semilla", "lanzamaiz", global.semilla_lanzamaiz);
ini_close();
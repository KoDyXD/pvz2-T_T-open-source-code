...
{
	global.nivel_cual = nivel_tutorial_1_5;	//siguiente nivel
	if global.trucos == false	//los trucos estan desactivados
	{
		if global.nivel_tutorial[4] = false	//si es la primera vez que se completa el nivel
		{
			...
			ini_close();
			instance_create_layer(global.xz, global.yz, "hud", recom_sem_papapum);
		}
